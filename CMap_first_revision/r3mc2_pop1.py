...
calculating_embryo_names_and_zero_timing_4cell = {'MT_pop-1_Sample1': 0, 'MT_pop-1_Sample2': 0}
...
#
# for target_cell_name in start_cells:
#     pd_volume_surface_irregularity_this=pd_volume_surface_irregularity.loc[pd_volume_surface_irregularity['Precedent']==target_cell_name+' sublineage']
...
#     print(target_cell_name+' sublineage',"  Peaks:")
#     for key, value in peaks:
#         print(f"Index: {key}, Value: {value}")
#
#     print(target_cell_name+' sublineage',"  Troughs:")
...
pd_volume_surface_irregularity = pd_volume_surface_irregularity_pop1.loc[
...
# ======================MS Arrow=======================
plt.arrow(
    x=8.58, y=2.5807+0.04,          # Starting point (x, y)
...
plt.arrow(
    x=13.97, y=2.286666-0.04,          # Starting point (x, y)
    dx=0, dy=0.01,        # Change in x (dx) and y (dy) - defines length and direction
    head_width=2.6,    # Width of the arrowhead
    head_length=0.02,   # Length of the arrowhead
    fc='black',         # Fill color for arrow (e.g., face color)
...
# plt.arrow(
#     x=24.31, y=2.623572+0.04,          # Starting point (x, y)
#     dx=0, dy=-0.01,        # Change in x (dx) and y (dy) - defines length and direction
#     head_width=2.6,    # Width of the arrowhead
#     head_length=0.02,   # Length of the arrowhead
#     fc='black',         # Fill color for arrow (e.g., face color)
...
plt.arrow(
    x=53.66, y=2.34412-0.04,          # Starting point (x, y)
    dx=0, dy=0.01,        # Change in x (dx) and y (dy) - defines length and direction
    head_width=2.6,    # Width of the arrowhead
    head_length=0.02,   # Length of the arrowhead
    fc='black',         # Fill color for arrow (e.g., face color)
...
# plt.arrow(
#     x=80.66, y=2.69028+0.04,          # Starting point (x, y)
#     dx=0, dy=-0.01,        # Change in x (dx) and y (dy) - defines length and direction
#     head_width=2.6,    # Width of the arrowhead
#     head_length=0.02,   # Length of the arrowhead
#     fc='black',         # Fill color for arrow (e.g., face color)
