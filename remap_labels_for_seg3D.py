...
pred_files_path = glob(os.path.join(source_folder, "CShaper_validating/SegCell/*segCell.nii.gz")) # change this when you are working on validation

# change this when you are working on validation
target_files_path = glob(os.path.join(source_folder, "GT/SegCell/*.nii.gz"))
