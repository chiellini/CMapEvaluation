...
# def get_hausdorff_distance(true,pred):
...
#         arr_true= true==true_id
#         arr_pred= pred==true_id
#         target_cell_label.append(true_id)
#         dist1 = directed_hausdorff(arr_true, arr_pred)[0]
#         dist2 = directed_hausdorff(arr_pred,arr_true)[0]
#         hausdorff_distance_list.append(max(dist1,dist2))
#     return target_cell_label,hausdorff_distance_list
...
def get_size_dice_and_iou(true, pred):
    ...
    target_cell_pixels = []
    for true_id in true_ids:
        overlap = np.logical_and(true==true_id, pred==true_id)
        unionlap=np.logical_or(true==true_id, pred==true_id)
        # print((true==true_id).sum() , (pred==true_id).sum())
        # print(overlap.sum())
        # print(unionlap.sum())
